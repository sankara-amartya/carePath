...
export function usePermissions() {
  ...
  // For development, defaulting to PRIMARY_CAREGIVER if no session/role exists
  // In a real app with Clerk role setup, you would use:
  // const userRole = (session?.user?.publicMetadata?.role as Role) || Role.PRIMARY_CAREGIVER;
